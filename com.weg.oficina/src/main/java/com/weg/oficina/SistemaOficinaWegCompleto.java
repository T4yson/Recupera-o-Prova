...
// GESTÃO DE ORDENS DE SERVIÇO (OS)
    ...
    static int[][] osAlunosEscalados = new int[100][3]; // Até 3 alunospor OS
        ...
        while (opcao != 0) {
            ...
            switch (opcao) {
                ...
                case 3: // EXECUTAR (Alunos)
                    ...
                    if (autorizado &
                            osStatus[idEx].equals("EXECUTANDO")) {
                ...
                case 4: // APROVAR (Professor)
                    ...
                    if (osProfessorResponsavel[idAp] == idPrAp && osStatus[idAp].equals("AGUARDANDO_APROVACAO")) {osStatus[idAp] = "CONCLUIDA";
...
//CADASTRO DE PROFESSORES
        ...
        tipos[0] = "PROFESSOR";
        usuariosNomes[1] = "Mestre Alexandre (WEG)"; tipos[1] = "PROFESSOR";
        totalPessoas = 2;
